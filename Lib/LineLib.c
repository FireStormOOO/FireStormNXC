#ifndef ____LineLibLoad____
#define ____LineLibLoad____
...
inline float l2GetAngle(l2Line line)
{
...
float l2InnerAngle(l2Line L1, l2Line L2)
{
     float angle = v2AngleBetween(L1.Dir, L2.Dir);
     angle %= 180;
     if(angle > 90.0)
         angle = 180 - angle;
     return angle;
...
float l2OuterAngle(l2Line L1, l2Line L2)
{
     float angle = v2AngleBetween(L1.Dir, L2.Dir);
     angle %= 180;
     if(angle < 90.0)
